import type { CronogramaDataMapped, ProjectModelData, StatusProjeto } from "@/lib/types/project"
import { parseValorModelo } from "@/lib/utils"
import { STATUS_PROJETO_LIST } from "@/constants/project"

export type { CronogramaDataMapped, ProjectModelData, StatusProjeto } from "@/lib/types/project"
export { STATUS_PROJETO_LIST, STATUS_PROJETO_STEPS } from "@/constants/project"

/**
 * Converte etapas_cronograma do projeto modelo para o formato do formulário de cronograma.
 * Usado para preenchimento automático quando projectId === 2.
 */

...
function FormularioJustificativa({ onChange, projectId }: PropsFormularioJustificativa) {
  ...
  const classeDoTextarea =
    "border-input placeholder:text-muted-foreground text-foreground w-full min-w-0 rounded-md border bg-background dark:bg-input/30 px-3 py-2 text-base shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] min-h-[8rem] resize-y md:text-sm"

  return (
    <div className="flex flex-col gap-8 rounded-[0.75rem] border border-input bg-muted p-6">
